...
class WeatherInformationServiceImplTests {
	...
	@Test
	public void saveOrUpdateWeatherInfoTest() {
        ...
        ResponseEntity<CityResponseDto> response = weatherInformationImpl.saveOrUpdateWeatherInfo(cityWeatherDto);
	...
	public void testAddCityWeatherInformationMissingCity() {
        ...
        CityWeather cityWeather = new CityWeather();
        when(weatherInformationDao.save(any(CityWeather.class))).thenReturn(cityWeather);
        assertThrows(CustomException.class, () -> {weatherInformationImpl.saveOrUpdateWeatherInfo(cityWeatherDto);});
    }
	...
	public void testAddCityWeatherInformationIncorrectCityValue() {
        ...
        assertThrows(InvalidInputException.class, () -> {weatherInformationImpl.saveOrUpdateWeatherInfo(cityWeatherDto);});
    }
